...
public class SimThresJaccardExp {
...
//					BurstEngine.computeMAX1Bursts("timeSeries"+trainingdocsFilename, burstsFilename, 0, 0, true,1);
				...
				extendLength =  Integer.parseInt(args[1]);
				int x = extendLength;
				int selector = BurstySimDater.TF;
				int scoreType = BurstySimDater.NODECNTSCORE;
				
						
				//Modify jaccardAlgorithm to report avg num of similar docs
				
				
				chk1.simThresJaccardAlgorithm(resultsFilename, timespan, selector, kJaccard, x, ktfidf, lucIndex2, scoreType, kCliques);
				//System.out.println("Min Jaccard:" + minJaccard);
				kJaccard+= 2;
